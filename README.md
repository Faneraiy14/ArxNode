...
повторний `arx install` завжди відтворює той самий байт-в-байт вміст,
...
Якщо `.arx`-скрипт запускається від імені твого сервісу (напр. код,
згенерований ШІ) — `ARX_SANDBOX=1 arx script.arx` обмежує файловий
